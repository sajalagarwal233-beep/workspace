...
export class DraftsClient {
    ...
    __create(inbox_id, request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/v0/inboxes/{inbox_id}/drafts");
        });
    }
    /**
     * @param {AgentMail.inboxes.InboxId} inbox_id
    ...
    __update(inbox_id, draft_id, request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return handleNonStatusCodeError(_response.error, _response.rawResponse, "PATCH", "/v0/inboxes/{inbox_id}/drafts/{draft_id}");
        });
    }
    /**
     * @param {AgentMail.inboxes.InboxId} inbox_id
