...
export class MessagesClient {
    ...
    __getAttachment(inbox_id, message_id, attachment_id, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/v0/inboxes/{inbox_id}/messages/{message_id}/attachments/{attachment_id}");
        });
    }
    /**
     * @throws {@link AgentMail.NotFoundError}
    ...
    __getRaw(inbox_id, message_id, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/v0/inboxes/{inbox_id}/messages/{message_id}/raw");
        });
    }
    /**
     * @param {AgentMail.inboxes.InboxId} inbox_id
