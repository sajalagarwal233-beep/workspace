...
export class ThreadsClient {
    ...
    __get(inbox_id, thread_id, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/v0/inboxes/{inbox_id}/threads/{thread_id}");
        });
    }
    /**
     * @param {AgentMail.inboxes.InboxId} inbox_id
    ...
    __delete(inbox_id, thread_id, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return handleNonStatusCodeError(_response.error, _response.rawResponse, "DELETE", "/v0/inboxes/{inbox_id}/threads/{thread_id}");
        });
    }
}
