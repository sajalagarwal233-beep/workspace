...
export class DomainsClient {
    ...
    __getZoneFile(domain_id, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/v0/domains/{domain_id}/zone-file");
        });
    }
    /**
    ...
    __verify(domain_id, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/v0/domains/{domain_id}/verify");
        });
    }
}
